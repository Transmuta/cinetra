defmodule Api.Waitlist.WaitlistNotifier do
  ...
  ## Fora de escopo (deferido, como a Presence na E3)

  O indicador ao vivo "alguém está oferecendo esta vaga" (`slot_held`/`slot_released` por vaga)
  **não** entra: a corrida já é segura pelo 409 da constraint, e o indicador exigiria rastrear
  holds ativos por item. Registrado como **não feito**, não como esquecido.
  """
  use Ash.Notifier
