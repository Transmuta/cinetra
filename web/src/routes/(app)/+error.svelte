...
<div class="grid h-full place-items-center p-8 text-center">
	<div>
		<div class="mx-auto mb-3 grid size-12 place-items-center rounded-cartao bg-surface-2 text-faint">
			<Construction size={24} />
		</div>
		<div class="font-mono text-titulo font-semibold text-faint">{page.status}</div>
		<!--
		...
		-->
		<h1 class="mt-1 text-destaque font-bold">
			{notFound ? 'Página não encontrada' : 'Algo deu errado'}
		</h1>
		<p class="mx-auto mt-1 max-w-[320px] text-corpo text-muted">
			{notFound
		...
		<a
			href="/agenda"
			class="mt-4 inline-block text-corpo font-semibold text-accent-text hover:underline"
		>
			Ir para a agenda
		</a>
	</div>
